...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12 relative z-20 pb-16" x-data="{ openMessageModal: false }">
    <div class="bg-white shadow-xl sm:rounded-sm border-t-4 border-[#8b0000] p-8 md:p-10 space-y-8">
        ...
        <div>
            ...
            <!-- Replace your current modal trigger button with this clean anchor link -->
            <a href="{{ route('messages.inbox', $user->id) }}" class="inline-flex items-center bg-emerald-700 hover:bg-emerald-800 text-white font-semibold py-2 px-4 rounded-md shadow-sm transition-colors text-sm">
